...
class Model(nn.Module):
    def __init__(self, output_size, vocab_size, embed_dim):
        ...
        self.hid_layer = nn.Linear(embed_dim, 128)
        self.hid_layer_2 = nn.Linear(128, 128)
    ...
    def forward(self, in_layer):
        ...
        h_out = F.relu(h_out)
        h_out_2 = self.hid_layer_2(h_out)
        h_out_2 = F.relu(h_out_2)
        out_ = self.out_layer(h_out_2)
...
if __name__ == '__main__':
    ...
    # device = torch.device("cuda")      # 将设备改为0号GPU
